...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/DOPSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "**Designation:** DOP" "index designation"
require_contains "$PARTS_DIR/_index.md" "BDS Documentation Protocol v2.0" "index protocol"
require_contains "$PARTS_DIR/_index.md" 'Primary output: `doc/DOPSYSTEM.md`' "index primary output"
require_contains "$PARTS_DIR/BUILD.sh" 'DESIGNATION="DOP"' "build designation"
...
require_contains "$ASSEMBLED_OUTPUT" "**Designation:** DOP" "assembled designation"
require_contains "$ASSEMBLED_OUTPUT" 'Primary output: `doc/DOPSYSTEM.md`' "assembled primary output"
